...
import hufs.ces.grimpan.core.GrimPanFXController;
...
public class SaxSVGPathParseHandler extends DefaultHandler{
	...
	private GrimPanFXController.SVGParseTask task = null;
	public SaxSVGPathParseHandler(GrimPanFXController.SVGParseTask task){
